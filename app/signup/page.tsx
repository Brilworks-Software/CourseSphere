          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                id="role"
                name="role"
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 transition-all"
                value={role}
                onChange={(e) => setRole(e.target.value as 'student' | 'admin')}
              >
                <option value="student">Learn from courses</option>
                <option value="admin">Teach and create courses</option>
              </select>
            </div>
          </div>
