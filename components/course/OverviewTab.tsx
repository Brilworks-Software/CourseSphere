...
export default function OverviewTab({ course, instructor, organization, lessonsCount, formattedTotal, rating, reviewsCount, studentsCount }: any) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-start gap-6">
        <div className="flex-1">
          ...
          {course?.expectations && (
            <div className="mt-6">
              <h4 className="text-base font-semibold mb-2">What you'll learn</h4>
